...
import com.brightleaf.resultservice.jwt.CORSFilter;
import com.brightleaf.resultservice.jwt.JwtAuthenticationEntryPoint;
import com.brightleaf.resultservice.jwt.JwtAuthenticationFilter;

@Configuration
@EnableWebSecurity
@EnableGlobalMethodSecurity(prePostEnabled = true)
public class ResultServiceSecurityConfig extends WebSecurityConfigurerAdapter {
	@Autowired
